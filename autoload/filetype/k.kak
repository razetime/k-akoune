...
add-highlighter shared/k/string  region '"' '"' fill string

add-highlighter shared/k/code/ regex ";" 0:meta
add-highlighter shared/k/code/ regex "[{}]" 0:meta
add-highlighter shared/k/code/ regex "\b[A-Za-z][A-Za-z0-9]*" 0:bright-black
add-highlighter shared/k/code/ regex "/|\\||\\:|/:|'|':" 0:yellow
add-highlighter shared/k/code/ regex "[\+-*%!&\|<>=~,\^#_\$\?@\.:]:?" 0:green
add-highlighter shared/k/code/ regex "-?\d+([ijl]|[NW][ijl]?|[nw]|(\.\d+)?(e-?\d+)?)?" 0:value
add-highlighter shared/k/code/ regex "`([A-Za-z][A-Za-z0-9]|)" 0:value
